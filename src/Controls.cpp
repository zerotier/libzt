...
#ifdef SDK_JNI
	extern "C" JNIEXPORT void JNICALL Java_com_zerotier_libzt_ZeroTier_stop(
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT void JNICALL Java_com_zerotier_libzt_ZeroTier_restart(
	JNIEnv *env, jobject thisObj)
{
	zts_restart();
}
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT void JNICALL Java_com_zerotier_libzt_ZeroTier_free(
	JNIEnv *env, jobject thisObj)
{
	zts_free();
}
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT jlong JNICALL Java_com_zerotier_libzt_ZeroTier_get_1node_1id(
	JNIEnv *env, jobject thisObj)
{
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT jint JNICALL Java_com_zerotier_libzt_ZeroTier_get_1node_1status(
	JNIEnv *env, jobject thisObj)
{
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT jint JNICALL Java_com_zerotier_libzt_ZeroTier_get_1network_1status(
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT jlong JNICALL Java_com_zerotier_libzt_ZeroTier_get_1peer_1status(
 ...
 */
	extern "C" JNIEXPORT jint JNICALL Java_com_zerotier_libzt_ZeroTier_init(
	JNIEnv *env, jobject thisObj)
{
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT jint JNICALL Java_com_zerotier_libzt_ZeroTier_join(
...
#ifdef SDK_JNI
	extern "C" JNIEXPORT jint JNICALL Java_com_zerotier_libzt_ZeroTier_leave(
	JNIEnv *env, jobject thisObj, jlong nwid)
{
