...
extern int pico_string_to_ipv4(const char *ipstr, uint32_t *ip)
{
...
extern int pico_ipv4_link_add(struct pico_device *dev, struct pico_ip4 address, struct pico_ip4 netmask)
{
